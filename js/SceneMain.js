class SceneMain extends Phaser.Scene {
  ...
  create() {
    ...
    // * инициализация ключевых переменных для переещения
    ...
    // * Создаем группы по простому массивы
  ...
  update() {
    ...
    if (!this.player.getData("isDead")) {
      ...
      // * стрельба игрока постоянная
      this.player.setData("isShooting", true);
      // * стрельба игрока по нажатию на пробел
